 ...
 */
#define SERIAL_PORT_2 -1  // Pour communication TFT
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 }  // E à calibrer
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -2.5 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point (à ajuster selon montage réel)
